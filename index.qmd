...
<div class="amd-stats">
  <div class="amd-stat">
    <div class="amd-stat-num">8</div>
    <div class="amd-stat-lbl">Partes</div>
  </div>
  <div class="amd-stat">
    <div class="amd-stat-num">58+</div>
...
Este curso naci&oacute; originalmente en el semestre 2026-II y se ha ido actualizando y enriqueciendo con el paso del tiempo. En la actualidad, est&aacute; fuertemente orientado a sentar las bases s&oacute;lidas del *Data Engineering* y *Data Science*, con el objetivo primordial de dotar a los estudiantes de herramientas que son directamente aplicables a la industria. A lo largo del texto encontrar&aacute;s ejemplos basados en casos de uso reales y pr&aacute;cticas guiadas con tecnolog&iacute;as modernas como PySpark y BigQuery.

En las tarjetas a continuaci&oacute;n podr&aacute;s explorar el contenido general del curso. Aunque la estructura est&aacute; dise&ntilde;ada con un orden de aprendizaje progresivo sugerido, los cap&iacute;tulos est&aacute;n construidos de manera autocontenida, lo que te permitir&aacute; consultar directamente los temas que m&aacute;s te interesen.

```{=html}
<div class="amd-learn-grid">
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte I</div>
    <div class="amd-learn-title">Entendimiento de Negocio</div>
    <div class="amd-learn-desc">Gesti&oacute;n de stakeholders, ciclo de vida de los datos, Business Understanding Canvas y traducci&oacute;n de necesidades.</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte II</div>
    <div class="amd-learn-title">Almacenes de Datos</div>
    <div class="amd-learn-desc">Arquitectura DW, modelo multidimensional, pipelines ETL/ELT con PySpark, dbt, Airflow y consumo OLAP.</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte III</div>
    <div class="amd-learn-title">Marco Metodol&oacute;gico</div>
    <div class="amd-learn-desc">Ciclo de vida con CRISP-DM aplicado paso a paso y metodolog&iacute;a para estructurar proyectos.</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte IV</div>
    <div class="amd-learn-title">An&aacute;lisis Exploratorio (EDA)</div>
    <div class="amd-learn-desc">EDA univariado y multivariado usando m&eacute;tricas de localizaci&oacute;n, variabilidad, forma y correlaci&oacute;n.</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte V</div>
    <div class="amd-learn-title">Preprocesamiento</div>
    <div class="amd-learn-desc">Pipelines de transformaci&oacute;n, imputaci&oacute;n, manejo de ruido, PCA y selecci&oacute;n de caracter&iacute;sticas con sklearn.</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte VI</div>
    <div class="amd-learn-title">Extracci&oacute;n de Patrones</div>
    <div class="amd-learn-desc">Reglas de asociaci&oacute;n, algoritmos Apriori y FP-Growth, m&eacute;tricas de soporte, confianza y lift.</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte VII</div>
    <div class="amd-learn-title">Clasificaci&oacute;n Supervisada</div>
    <div class="amd-learn-desc">&Aacute;rboles, Random Forest, XGBoost, modelos lineales, SVM, m&eacute;todos probabil&iacute;sticos y Redes Neuronales (PyTorch/JAX).</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Parte VIII</div>
    <div class="amd-learn-title">Aprendizaje No Supervisado</div>
    <div class="amd-learn-desc">Clustering (K-Means, Jer&aacute;rquico, DBSCAN) y reducci&oacute;n de dimensionalidad (t-SNE, UMAP).</div>
  </div>
  <div class="amd-learn-card">
    <div class="amd-learn-kw">Transversal</div>
    <div class="amd-learn-title">Herramientas Modernas</div>
    <div class="amd-learn-desc">PySpark, Databricks, Delta Lake, dbt, Airflow, sklearn, PyTorch y JAX con visualizaciones interactivas.</div>
  </div>
</div>
```
...
<div class="amd-syllabus">
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      ...
      <span class="amd-part-name">Entendimiento de Negocio</span>
      <span class="amd-part-count">3 cap&iacute;tulos</span>
    </div>
    <div class="amd-part-body">
      <div class="amd-chips">
        <span class="amd-chip">Stakeholders</span>
        <span class="amd-chip">Ciclo de vida</span>
        <span class="amd-chip">Business Understanding Canvas</span>
      </div>
    </div>
  </div>
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      ...
      <span class="amd-part-name">Marco Metodol&oacute;gico</span>
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      ...
      <span class="amd-part-name">An&aacute;lisis Exploratorio de Datos (EDA)</span>
      <span class="amd-part-count">15 cap&iacute;tulos</span>
    </div>
    <div class="amd-part-body">
      <div class="amd-chips">
        <span class="amd-chip">Localizaci&oacute;n</span>
        <span class="amd-chip">Variabilidad</span>
        <span class="amd-chip">Forma</span>
        <span class="amd-chip">Heterogeneidad</span>
        <span class="amd-chip">Concentraci&oacute;n</span>
        <span class="amd-chip">Correlaci&oacute;n</span>
        <span class="amd-chip">Dashboard</span>
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      ...
      <span class="amd-part-name">Preprocesamiento</span>
      <span class="amd-part-count">6 cap&iacute;tulos</span>
    </div>
    <div class="amd-part-body">
      <div class="amd-chips">
        <span class="amd-chip">sklearn Pipeline</span>
        <span class="amd-chip">Conversi&oacute;n</span>
        <span class="amd-chip">Imputaci&oacute;n</span>
        <span class="amd-chip">Ruido</span>
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      <span class="amd-part-num">VI</span>
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      <span class="amd-part-num">VII</span>
      <span class="amd-part-name">Clasificaci&oacute;n</span>
      <span class="amd-part-count">13 cap&iacute;tulos</span>
    </div>
    <div class="amd-part-body">
      <div class="amd-chips">
        <span class="amd-chip">Evaluaci&oacute;n ROC/AUC</span>
        <span class="amd-chip">&Aacute;rboles</span>
        <span class="amd-chip">Random Forest</span>
        <span class="amd-chip">XGBoost</span>
        <span class="amd-chip">Modelos Lineales</span>
        <span class="amd-chip">SVM</span>
        <span class="amd-chip">Bayesianos &middot; GMM</span>
        <span class="amd-chip">Redes Neuronales (PyTorch/JAX)</span>
      </div>
    </div>
  </div>
  ...
  <div class="amd-part">
    <div class="amd-part-header">
      <span class="amd-part-num">VIII</span>
    ...
    <div class="amd-part-body">
      <div class="amd-chips">
        ...
        <span class="amd-chip">K-Means</span>
        <span class="amd-chip">Jer&aacute;rquico</span>
        <span class="amd-chip">DBSCAN</span>
...
Quiero expresar mi profundo agradecimiento a la profesora **Jessica Santizo** por su invaluable invitaci&oacute;n a participar de manera inicial en este curso, as&iacute; como por sus invaluables contribuciones y discusiones que han sido fundamentales para el mejoramiento continuo de este material.

Un agradecimiento muy especial a **las y los alumnos** que han cursado la materia; sus dudas, comentarios y retroalimentaci&oacute;n constante han fortalecido enormemente la calidad y claridad del contenido en estas notas.

A la **Universidad Nacional Aut&oacute;noma de M&eacute;xico (UNAM)**, nuestra gran casa de estudios; un baluarte invaluable del conocimiento libre y accesible para todos.

Finalmente, extiendo mi gratitud a los creadores de los diversos cursos y materiales en l&iacute;nea de m&uacute;ltiples entidades, comunidades y empresas tecnol&oacute;gicas. Gracias a su libre disposici&oacute;n y compromiso con el conocimiento abierto, ha sido posible la estructuraci&oacute;n y realizaci&oacute;n de estas notas.
...
## C&oacute;mo citar {.unnumbered}

Si utilizas este material en tus trabajos, proyectos o investigaciones, por favor utiliza la siguiente cita en formato BibTeX:

```bibtex
@misc{villalba2026almacenes,
  title={Almacenes y Miner\'{i}a de Datos},
  author={Villalba, Diego},
  year={2026},
  howpublished={Repositorio de GitHub / GitHub Pages},
  note={Notas de curso de autor\'{i}a propia},
