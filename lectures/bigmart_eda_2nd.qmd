...
hallazgos = [
    ("Heterogeneidad",
     ...
     "Alta variabilidad entre tiendas (CV: 57%–77%).\n"
     "El desempeño depende fuertemente del tipo de outlet."),
    
    ("Concentración",
     "No se cumple la regla 80/20.\n"
     "Gini ≈ 0.33 → concentración moderada.\n"
     "Las categorías líderes aportan una fracción relevante, pero no dominante."),
    
    ("Correlación",
     "Precio (MRP) es el predictor más fuerte (r ≈ 0.57).\n"
     "Visibilidad tiene correlación negativa (r ≈ -0.13).\n"
     "Peso y antigüedad muestran poca relación con ventas."),
    
    ("PCA",
     "PC1 + PC2 explican ~60% de la varianza.\n"
     "PC1 captura contraste precio vs antigüedad.\n"
     "Grocery Store se separa claramente del resto.")
]
...
fig = go.Figure(data=[go.Table(
    ...
    header=dict(
        ...
        fill_color=AZUL,
        font=dict(color=FONDO, size=13),
        align='left',
        height=36
    ),
    cells=dict(
        values=[
            [h[0] for h in hallazgos],
...
fig.update_layout(
    title=dict(
        text="Síntesis de hallazgos — EDA BigMart",
