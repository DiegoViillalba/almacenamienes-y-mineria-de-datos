...
execute:
  ...
  message: false
  cache: false
bibliography: [referencias_bayesianos.bib, ../../../references.bib]
crossref:
  fig-title: "Figure"
  tbl-title: "Table"
  eq-prefix: "Eq."
...
![Prior probability of finding the car behind closed doors is $\frac{1}{3}$, while finding a goat is $\frac{2}{3}$.](../../images/external/monty-hall-closed-doors.png){width="65%"}
...
![Opening a goat door constraints the host to reveal a goat, shifting the conditional probability of winning by switching to $\frac{2}{3}$.](../../images/external/monty-hall-open-door.png){width="65%"}
...
Naïve Bayes simplifies multidimensional density estimation by assuming feature conditional independence given class $\omega_i$ [@mccallum1998comparison; @murphy2012]:
...
- **Linear Discriminant Analysis (LDA):** Shared covariance matrix $\boldsymbol{\Sigma}_i = \boldsymbol{\Sigma}$ yields linear decision hyperplanes [@fisher1936use; @hastie2009].
