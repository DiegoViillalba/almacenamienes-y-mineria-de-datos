...
Esta sección usa widgets interactivos (OJS) que solo funcionan en la versión web del libro. Consúltala en línea para explorar las cinco operaciones OLAP (slice, dice, roll-up, drill-down, pivot) sobre el cubo de ejemplo.
:::
...
Las medidas de un cubo pueden ser simples o derivadas. Una medida simple es la suma de ventas; una medida derivada puede ser participación porcentual, crecimiento trimestral o margen. En OLAP conviene distinguir entre medidas aditivas, semi-aditivas y no aditivas [@kimball2013].
