...
# Integración al dashboard global

Este capítulo puede incorporarse al dashboard global de dos maneras:

- como una **sección adicional** dedicada a relaciones entre variables;
- o como un **apéndice analítico** que complemente las cinco dimensiones principales del EDA.

Si decides integrarlo al libro principal, la secuencia podría quedar así:
...
book:
  chapters:
    ...
    - 07_correlacion_bigmart.qmd
```

Así, el lector contará con una visión todavía más completa del análisis exploratorio del conjunto de datos.
