...
<!-- TODO: MENCIONAR QUE PARA UNA MEJRO COMPARACIÓN EN MEDIDAS DE HETEOOGENEIDAD ES NECESARIO COLOCAR LOS VALORES MAXIMOS A UNA COSTADO. -->


## Introducción

::: {.callout-tip appearance="minimal"}
Este caso aplica la diversidad categórica y la comparación entre grupos desarrolladas en [Medidas de heterogeneidad](2-6-heterogeneidad.qmd).
:::
...
**Definición operativa.** La heterogeneidad aparece cuando la distribución de ventas cambia entre subgrupos o cuando la composición categórica presenta diversidad relevante [@shannon1948mathematical; @simpson1949measurement].
:::
...
La entropía anterior describe diversidad de participaciones. El coeficiente de Gini basado en la curva de Lorenz responde específicamente a desigualdad y se desarrolla, con su fórmula corregida, en [Medidas de concentración en Big Mart Sales](2-7-concentracion_bigmart.qmd).
:::
