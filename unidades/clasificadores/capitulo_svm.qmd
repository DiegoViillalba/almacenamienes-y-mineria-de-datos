...
Cuando se usa el kernel RBF (@eq-rbf-kernel), la SVM tiene dos hiperparámetros principales que deben ajustarse mediante validación cruzada [@hastie2009]:
...
Al aplicar SVM a un problema real, las siguientes recomendaciones pueden mejorar significativamente los resultados [@chang2011libsvm; @hastie2009]:
