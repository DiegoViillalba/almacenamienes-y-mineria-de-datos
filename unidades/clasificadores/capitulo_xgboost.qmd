...
execute:
  ...
  message: false
  cache: false
bibliography: [referencias_xgboost.bib, ../../references.bib]
crossref:
  fig-title: "Figura"
  tbl-title: "Tabla"
  eq-prefix: "Ec."
...
1. **Estrategia de ajuste de hiperparametros:** Comenzar con `learning_rate=0.1` y `n_estimators=200–500`. Una vez identificado un buen numero de arboles mediante *early stopping*, reducir la tasa de aprendizaje a 0.05 o 0.01 y aumentar proporcionalmente los estimadores para refinar el modelo [@hastie2009].
